...
import { ICourseInfo, ICourseMessageResponse, IAiCourseResponse } from "../../../apis/course/types";
...
export const useGetAiKaKaoCourseAndId = (tripId: string | undefined) => {
    return useQuery<{ aiCourseId: string; aiKaKaoCourse: Route[]; aiCourse: IAiCourseResponse }>({
