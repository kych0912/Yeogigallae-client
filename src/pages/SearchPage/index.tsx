...
export default function SearchPage() {
    ...
    const { currentPage, setResults, setTotalPages } = useSearch();
    ...
    return (
        <>
            ...
            {!isLoading && placeData && placeData.documents.length > 0 && <ResultList results={placeData.documents} coords={coordData} />}

            {placeData && <Pagination />}
        </>
    );
}
