...
export default function RecommendCard() {
    ...
    const { aiCourseId } = useParams<{ aiCourseId: string }>(); // tripId 가져오기
        ...
        <Card>
            <S.Recommend.RecommendContainer>
                ...
                <S.Recommend.RecommendButtonWrapper>
                    <S.Recommend.RecommendButton onClick={() => navigate(`/budget/${aiCourseId}`)}>{"AI가 짜준 코스를 바탕으로 예산 짜러 가기"}</S.Recommend.RecommendButton>
